...
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck2.txt python -u deck-n-l-gine.py 2 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck3.txt python -u deck-n-l-gine.py 3 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deckhalf.txt python -u deck-n-l-gine.py half & """
...
for _ in range(5):
    ...
    model = NetSubgraphGINE( node_size, edge_size, hidden_size, 3 )
