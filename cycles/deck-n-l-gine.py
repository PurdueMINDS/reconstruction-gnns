...
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck1.txt python -u deck-n-l-gine.py 1  & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ipanema-gpu --output=deck2.txt python -u deck-n-l-gine.py 2 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml01-gpu,ml02-gpu,ml03-gpu,ml04-gpu,ml05-gpu,ml06-gpu,ml07-gpu,ml08-gpu  --output=deck3.txt python -u deck-n-l-gine.py 3 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml01-gpu,ml02-gpu,ml03-gpu,ml04-gpu,ml05-gpu,ml06-gpu,ml07-gpu,ml08-gpu  --output=deck3-half.txt python -u deck-n-l-gine.py half & """

# nohup python -u deck-n-l-gine.py 3 4 36 > deck3-4.txt &
# nohup python -u deck-n-l-gine.py half 4 36 > deckhalf-4.txt &

# nohup python -u deck-n-l-gine.py 1 6 56 > deck1-6.txt &
# nohup python -u deck-n-l-gine.py 2 6 56 > deck2-6.txt &
# nohup python -u deck-n-l-gine.py 3 6 56 > deck3-6.txt &
# nohup python -u deck-n-l-gine.py half 6 56 > deckhalf-6.txt &

""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck1-8.txt python -u deck-n-l-gine.py 1 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck2-8.txt python -u deck-n-l-gine.py 2 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deck3-8.txt python -u deck-n-l-gine.py 3 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=urca-gpu --output=deckhalf-8.txt python -u deck-n-l-gine.py half 8 72 & """
...
for _ in range(5):
    ...
    lr = 0.001
    model = NetSubgraphGINE( node_size, edge_size, hidden_size, 2, k )
