...
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml-all-gpu --output=deck1-4pna.txt python -u deck-n-l-pna.py 1 4 36 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml-all-gpu --output=deck2-4pna.txt python -u deck-n-l-pna.py 2 4 36 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml-all-gpu --output=deck3-4pna.txt python -u deck-n-l-pna.py 3 4 36 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml-all-gpu --output=deckhalf-4pna.txt python -u deck-n-l-pna.py half 4 36 & """

""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ml-all-gpu --output=deck1-6pna.txt python -u deck-n-l-pna.py 1 6 56 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ipanema-gpu --output=deck2-6pna.txt python -u deck-n-l-pna.py 2 6 56 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ipanema-gpu --output=deck3-6pna.txt python -u deck-n-l-pna.py 3 6 56 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=ipanema-gpu --output=deckhalf-6pna.txt python -u deck-n-l-pna.py half 6 56 & """

""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=copa-gpu --output=deck1-8pna.txt python -u deck-n-l-pna.py 1 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=copa-gpu --output=deck2-8pna.txt python -u deck-n-l-pna.py 2 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=copa-gpu --output=deck3-8pna.txt python -u deck-n-l-pna.py 3 8 72 & """
""" Run: $ srun -n 1 --gres=gpu:1 --cpus-per-task=1 --nice=1000 --partition=copa-gpu --output=deckhalf-8pna.txt python -u deck-n-l-pna.py half 8 72 & """
...
total = 0
for data in dataset:
    total += data.edge_index.size(1)/2
...
for _ in range(5):
    ...
    lr = 0.001
    model = NetSubgraphPNA(node_size, edge_size, 2, deg, k)
    ...
    def train():
        ...
        for i in range(0, len(train_dataset), batch_size):
            ...
            output = F.log_softmax(model(torch.zeros((subgraph_data.x.size(0),1)).to(device).long(), subgraph_data.edge_index, torch.zeros((subgraph_data.edge_index.size(1),1)).to(device).long(), subgraph_data.batch, weights, subgraph_batch), dim=-1)
